...
// for StartNavigate in navigatee
function startNavigation() {
  // Get the elements to move
  var originInput = document.getElementById('origin');
  var originLabel = document.querySelector('label[for="origin"]');
  var destnameLabel = document.getElementById('destname');
  var destinationLabel = document.querySelector('label[for="destination"]');
  var resetButton = document.querySelector('.reset');

  // Move the elements to the box-above-navbar
  var boxAboveNavbar = document.querySelector('.box-above-navbar');
  boxAboveNavbar.appendChild(originInput);
  boxAboveNavbar.appendChild(originLabel);
  boxAboveNavbar.appendChild(destnameLabel);
  boxAboveNavbar.appendChild(destinationLabel);
  boxAboveNavbar.appendChild(resetButton);

  // Hide unnecessary elements
  document.querySelector('.box-above-navbar .navigateButton').style.display = 'none';
  document.getElementById('navigate').style.display = 'block'; // Show navigate content
}


//for Reset button
function resetNavigation() {
  var navigateContent = document.getElementById('navigate-content');
  var boxAboveNavbar = document.querySelector('.box-above-navbar');

  // Move elements back to navigate content
  navigateContent.appendChild(document.getElementById('origin'));
  navigateContent.appendChild(document.querySelector('label[for="origin"]'));
  navigateContent.appendChild(document.getElementById('destname'));
  navigateContent.appendChild(document.querySelector('label[for="destination"]'));
  navigateContent.appendChild(document.querySelector('.reset'));

  // Toggle visibility of Start Navigation button
  document.querySelector('.box-above-navbar .navigateButton').style.display = 'block';

  // Hide navigate content
  document.getElementById('navigate').style.display = 'none';

  // Show nav-info and map
  document.querySelector('.nav-info').style.display = 'block';
  document.getElementById('map').style.display = 'block';

  // Reset input values in navigate content
